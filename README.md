...
2. **Em grupo:**
   - Comparem suas respostas e cheguem a um consenso.
   - Conjuntamente, comecem a construir o código aos poucos, tentando cumprir um objetivo de cada vez (entregar).
   - Compilem o código a cada mudança.

3. **Individualmente reflita sobre:**
   - Eu li a especificação com mais cuidado? Entendi melhor a especificação após a interação com meus colegas em classe? (entregar).
   - A atividade contribuiu para me tornar mais seguro quanto à interpretação de problemas?
   - Buscar analogias com problemas anteriores me ajudou a resolver o problema?
   - Entender melhor os objetivos me ajudou a programar?
   - Cumprir um objetivo de cada vez nos ajudou a resolver o problema?
   - Compilar o código a cada mudança nos ajudou a programar?
   - Participei ativamente da codificação em grupo?

## Rubrica do Professor

| **Nível**  | **Critérios de Avaliação** |
|------------|---------------------------|
| **Nível 5** | ✅ O aluno analisou corretamente os dados de entrada e saída.<br>✅ Verificou os tipos mais adequados para as variáveis.<br>✅ Compreendeu bem os objetivos do problema colocado.<br>✅ Fez mais de uma analogia adequada com problema prévio similar.<br>✅ Adaptou solução para resolver o problema.<br>✅ Codificou muito bem para comparar com os colegas.<br>✅ Participação excelente durante a codificação em grupo.<br>✅ Entendeu a especificação. |
| **Nível 4** | ✅ O aluno analisou corretamente os dados de entrada e saída.<br>✅ Verificou os tipos mais adequados para as variáveis.<br>✅ Compreendeu bem os objetivos do problema colocado.<br>✅ Fez analogia adequada com problema prévio similar.<br>✅ Adaptou solução para resolver o problema.<br>✅ Codificou bem para comparar com os colegas.<br>✅ Participação boa durante a codificação em grupo.<br>✅ Entendeu a especificação.<br>✅ Compreendeu melhor a especificação após a interação com o grupo. |
| **Nível 3** | ⚠️ O aluno analisou corretamente os dados de entrada e saída.<br>⚠️ Verificou os tipos mais adequados para as variáveis.<br>⚠️ Compreendeu razoavelmente os objetivos do problema colocado.<br>⚠️ Fez alguma analogia com problema prévio similar.<br>⚠️ Tentou adaptar solução para resolver o problema.<br>⚠️ Codificou razoavelmente para comparar com os colegas.<br>⚠️ Participação regular durante a codificação em grupo.<br>⚠️ Entendeu regularmente a especificação. |
| **Nível 2** | ❌ O aluno analisou erroneamente os dados de entrada e saída.<br>❌ Verificou erroneamente os tipos mais adequados para as variáveis.<br>❌ Não compreendeu os objetivos do problema colocado.<br>❌ Não fez nenhuma analogia com problema prévio similar.<br>❌ Não adaptou nenhuma solução para resolver o problema.<br>❌ Codificou erroneamente para comparar com os colegas.<br>❌ Participação fraca durante a codificação em grupo.<br>❌ Leu a especificação, mas a compreendeu fracamente, mesmo interagindo com os colegas. |
| **Nível 1** | ❌ O aluno não analisou os dados de entrada e saída.<br>❌ Não verificou os tipos mais adequados para as variáveis.<br>❌ Não refletiu sobre os objetivos do problema colocado.<br>❌ Não fez nenhuma analogia com problema prévio similar.<br>❌ Não adaptou nenhuma solução prévia para resolver o problema.<br>❌ Não codificou nada para comparar com os colegas.<br>❌ Não participou ativamente da codificação em grupo.<br>❌ Não leu a especificação ou não a compreendeu, mesmo interagindo com os colegas. |


## Tarefa: Detectando Itens Importantes do Problema Antes da Codificação

### Importância da Tarefa
A codificação para resolver problemas é uma das atividades de aprendizagem mais comuns para a prática de programação. No entanto, essa única atividade não é suficiente para ajudar os alunos a construírem seu desenvolvimento cognitivo da programação passo a passo; ou seja, várias atividades na sequência adequada são necessárias para praticar a programação. Uma estratégia essencial a ser realizada antes da codificação é o entendimento do problema e a ativação de conhecimentos prévios para resolver o problema.
...
3. **Individualmente reflita sobre:**  
   - Eu li a especificação com mais cuidado? Entendi melhor a especificação após a interação com meus colegas em classe? Em minha interpretação a especificação é *(Entregar.)*  
   - A atividade contribuiu para me tornar mais seguro quanto à interpretação de problemas?  
   - Buscar analogias com problemas anteriores me ajudou a resolver o problema?  
   - Entender melhor os objetivos me ajudaram a programar?  
   - Cumprir um objetivo de cada vez nos ajudou a resolver o problema?  
   - Compilar o código a cada mudança nos ajudou a programar?  
   - Participei ativamente da codificação em grupo?  
...
### **Tarefa:**
**Estabelecendo um entendimento compartilhado sobre conceitos de programação.**

### **Importância da Tarefa:**
A técnica Jigsaw é utilizada para explorar questões fundamentais das linguagens de programação, aprimorando a compreensão dos alunos sobre elementos básicos da linguagem. Esta técnica envolve entrevistas e compartilhamento de informações para aprofundar o entendimento sobre diferentes tipos de erros de programação.
...
**Definição do Problema:** Promover um *mindset* positivo nos alunos para que eles possam enfrentar desafios de programação de maneira mais eficaz, utilizando o diálogo interno positivo para melhorar a motivação, o engajamento e o desempenho.
...
**Definição do problema:** Utilizar a ferramenta *Kanban* para gerenciar e avaliar o aprendizado dos conceitos de programação, desde o estudo inicial até a confirmação de que o conceito foi completamente aprendido.
...
## Tarefa: Estabelecendo um entendimento compartilhado sobre conceitos de programação
...
- Usar a troca dinâmica de código foi útil para mim? Por quê? (entregar).
- A troca dinâmica de código me permitirá aprender melhor programação de computadores? Por quê? (entregar).
- A troca dinâmica de código me permitirá aprender programação de computadores mais rapidamente? Por quê? (entregar).
- A troca dinâmica aumentou minha produtividade na resolução de problemas computacionais? De que modo? (entregar).
- A troca dinâmica aumentou minha produtividade em programação? Como? (entregar).

## Rubrica do Professor

| **Nível**  | **Critérios de Avaliação** |
|------------|---------------------------|
| **Nível 5** | ✅ O aluno desenvolveu a primeira versão do código correta e realizou várias trocas dinâmicas eficazes.<br>✅ O aluno desenvolveu versões do código intermediárias corretas e a última versão do código também foi correta.<br>✅ A versão do código coletivo entregue foi excelente e melhor do que a primeira.<br>✅ O aluno respondeu em profundidade se a troca dinâmica foi útil, auxiliando em uma melhor aprendizagem e uma aprendizagem mais rápida.<br>✅ O aluno respondeu em profundidade se a troca dinâmica aumentou sua produtividade na resolução de problemas computacionais e em programação. |
| **Nível 4** | ✅ O aluno desenvolveu a primeira versão do código correta.<br>✅ O aluno realizou várias trocas dinâmicas.<br>✅ O aluno desenvolveu versões do código intermediárias corretas.<br>✅ O aluno desenvolveu a última versão do código correta.<br>✅ A versão do código coletivo entregue foi correta.<br>✅ O aluno respondeu bem se a troca dinâmica foi útil.<br>✅ O aluno respondeu bem se a troca dinâmica auxiliará em uma melhor aprendizagem.<br>✅ O aluno respondeu bem se a troca dinâmica auxiliará em uma aprendizagem mais rápida.<br>✅ O aluno respondeu bem se a troca dinâmica aumentou sua produtividade na resolução de problemas computacionais.<br>✅ O aluno respondeu bem se a troca dinâmica aumentou sua produtividade em programação. |
| **Nível 3** | ⚠️ O aluno desenvolveu a primeira versão do código parcialmente correta.<br>⚠️ O aluno realizou mais de 1 troca dinâmica.<br>⚠️ O aluno desenvolveu versões do código intermediárias parcialmente corretas.<br>⚠️ O aluno desenvolveu a última versão do código parcialmente correta.<br>⚠️ A versão do código coletivo entregue foi parcialmente correta.<br>⚠️ O aluno respondeu de forma regular se a troca dinâmica foi útil.<br>⚠️ O aluno respondeu de forma regular se a troca dinâmica auxiliará em uma melhor aprendizagem.<br>⚠️ O aluno respondeu de forma regular se a troca dinâmica auxiliará em uma aprendizagem mais rápida.<br>⚠️ O aluno respondeu de forma regular se a troca dinâmica aumentou sua produtividade na resolução de problemas computacionais.<br>⚠️ O aluno respondeu de forma regular se a troca dinâmica aumentou sua produtividade em programação. |
| **Nível 2** | ❌ O aluno desenvolveu a primeira versão do código errada ou incompleta.<br>❌ O aluno realizou apenas 1 troca dinâmica.<br>❌ O aluno desenvolveu versões do código intermediárias erradas ou incompletas.<br>❌ O aluno desenvolveu a última versão do código errada ou incompleta.<br>❌ A versão do código coletivo entregue foi errada ou incompleta.<br>❌ O aluno respondeu de forma superficial se a troca dinâmica foi útil.<br>❌ O aluno respondeu de forma superficial se a troca dinâmica auxiliará em uma melhor aprendizagem.<br>❌ O aluno respondeu de forma superficial se a troca dinâmica auxiliará em uma aprendizagem mais rápida.<br>❌ O aluno respondeu de forma superficial se a troca dinâmica aumentou sua produtividade na resolução de problemas computacionais.<br>❌ O aluno respondeu de forma superficial se a troca dinâmica aumentou sua produtividade em programação. |
| **Nível 1** | ❌ O aluno não desenvolveu a primeira versão do código.<br>❌ O aluno não realizou nenhuma troca dinâmica.<br>❌ O aluno não desenvolveu nenhuma versão do código intermediária.<br>❌ O aluno não desenvolveu a última versão do código.<br>❌ O grupo não entregou a versão do código coletivo.<br>❌ O aluno não respondeu se a troca dinâmica foi útil.<br>❌ O aluno não respondeu se a troca dinâmica auxiliará em uma melhor aprendizagem.<br>❌ O aluno não respondeu se a troca dinâmica auxiliará em uma aprendizagem mais rápida.<br>❌ O aluno não respondeu se a troca dinâmica aumentou sua produtividade na resolução de problemas computacionais.<br>❌ O aluno não respondeu se a troca dinâmica aumentou sua produtividade em programação. |
...
4. **Avaliação da eficácia** – Analisar como essas estratégias afetaram a ansiedade, motivação e desempenho em programação. *(Entrega: avaliação da eficácia).*
5. **Reflexão e ajustes futuros** – Identificar estratégias mais úteis e planejar melhorias. *(Entrega: reflexão final e plano de ajustes).*
...
| **Nível**  | **Critérios de Avaliação** |
|------------|---------------------------|
| **Nível 5** | ✅ Treinamento exemplar em comunicação positiva com prática exemplar.<br>✅ Excelente uso de linguagem positiva e apoio mútuo, com resolução eficaz de todos os conflitos.<br>✅ Avaliação exemplar das estratégias de comunicação, demonstrando impacto significativo no ambiente do grupo.<br>✅ Reflexões profundas e planos de ação exemplares para contínua melhoria das relações de confiança.<br>✅ Plano de melhoria excepcional, detalhado e inovador, garantindo a continuidade do desenvolvimento das relações dentro do grupo. |
| **Nível 4** | ✅ Treinamento eficaz e prática consistente de comunicação positiva.<br>✅ Linguagem positiva bem integrada nas sessões, com excelente gestão de conflitos.<br>✅ Avaliação detalhada e positiva das estratégias de comunicação.<br>✅ Reflexões profundas e construtivas que resultam em melhorias significativas.<br>✅ Plano de melhoria bem elaborado e específico para fortalecer as relações no grupo. |
| **Nível 3** | ⚠️ Treinamento adequado e prática regular de comunicação positiva.<br>⚠️ Uso frequente de linguagem positiva com resolução eficaz de alguns conflitos.<br>⚠️ Avaliação razoável da eficácia das estratégias com algumas sugestões de melhoria.<br>⚠️ Reflexões útis que levam a algumas melhorias.<br>⚠️ Plano de melhoria razoável com ações concretas. |
| **Nível 2** | ❌ Treinamento básico de comunicação positiva realizado, mas aplicação inconsistente.<br>❌ Algum uso de linguagem positiva, mas persistência de conflitos não resolvidos.<br>❌ Avaliação realizada, mas com poucas conclusões útis.<br>❌ Reflexões superficiais sem ações corretivas efetivas.<br>❌ Plano de melhoria limitado e pouco específico. |
| **Nível 1** | ❌ Falha no treinamento ou na prática de comunicação positiva.<br>❌ Uso frequente de linguagem negativa ou crítica durante as sessões.<br>❌ Avaliação da eficácia da comunicação não realizada ou negativa.<br>❌ Reflexão individual e em grupo não realizada ou ineficaz.<br>❌ Falta de plano de melhoria ou plano muito básico. |


## Tarefa: Promovendo a Participação em Programação

### Importância da Tarefa
Esta atividade se concentra em melhorar a interação e a participação dentro de grupos de programação. A tarefa envolve a nomeação de um líder que facilitará a comunicação e o compartilhamento de ideias, incentivando uma abordagem colaborativa e participativa à resolução de problemas de programação.
...
4. **Avaliação da eficácia das estratégias:** Após a sessão, o grupo avalia a eficácia das estratégias de comunicação e participação implementadas pelo líder. Discutir o que funcionou bem e o que pode ser melhorado (entregar avaliação da sessão).
5. **Reflexão e ajustes futuros:** O grupo reflete sobre a experiência e planeja ajustes nas estratégias de participação para sessões futuras, considerando o *feedback* dos membros e as observações do líder (entregar reflexão e plano de ajustes).

## Rubrica do Professor

| **Nível**  | **Critérios de Avaliação** |
|------------|---------------------------|
| **Nível 5** | ✅ Líder exemplar escolhido com justificativa inspiradora.<br>✅ Estratégias de comunicação excepcionais que promovem uma participação excelente.<br>✅ Participação exemplar durante a sessão, com engajamento ativo e produtivo de todos os membros.<br>✅ Avaliação exemplar das estratégias com *feedback* construtivo e inovador.<br>✅ Reflexões e ajustes exemplares que garantem a continuidade e o aprimoramento da participação e do aprendizado colaborativo. |
| **Nível 4** | ✅ Líder muito eficaz escolhido com excelente justificativa.<br>✅ Estratégias de comunicação criativas e efetivamente implementadas.<br>✅ Alta participação durante a sessão, com contribuições valiosas de todos os membros.<br>✅ Avaliação detalhada e positiva das estratégias, com várias melhorias identificadas.<br>✅ Reflexão profunda e planos de ajustes bem elaborados. |
| **Nível 3** | ⚠️ Líder eficaz escolhido com justificativa adequada.<br>⚠️ Estratégias de comunicação bem desenvolvidas e parcialmente implementadas.<br>⚠️ Boa participação durante a sessão, com a maioria dos membros contribuindo.<br>⚠️ Avaliação razoável da eficácia das estratégias com algumas sugestões de melhoria.<br>⚠️ Reflexão adequada e alguns ajustes planejados para melhorar a participação. |
| **Nível 2** | ❌ Líder escolhido, mas com eficácia limitada.<br>❌ Estratégias de comunicação básicas desenvolvidas, mas implementação fraca.<br>❌ Alguma participação durante a sessão, mas sem envolvimento de todos os membros.<br>❌ Avaliação realizada, mas com poucas conclusões úteis.<br>❌ Reflexão superficial com poucos ou nenhum ajuste planejado. |
| **Nível 1** | ❌ Líder não escolhido ou escolha ineficaz sem justificativa clara.<br>❌ Falha em desenvolver ou implementar estratégias de comunicação.<br>❌ Participação desigual ou mínima durante a sessão de programação.<br>❌ Avaliação da eficácia não realizada ou muito crítica sem sugestões construtivas.<br>❌ Falta de reflexão ou plano de ajustes. |
...
- O escritor desenvolve um plano inicial e esboço do programa. *(entregar)*
- O consultor pesquisa e fornece informações relevantes para aconselhar o escritor. *(entregar)*
- O editor e o revisor preparam-se para modificar e comentar o plano e esboço inicial. *(entregar)*

### **Durante a sala de aula:**
- O escritor detalha o programa com a ajuda do consultor. *(entregar)*
- Possível realocação de papéis conforme necessidade ou desejo do grupo. *(entregar)*
- O editor realiza as alterações necessárias no código. *(entregar)*
- O editor e o revisor continuam a oferecer *feedback* e fazer ajustes no código. *(entregar)*

### **Depois da sala de aula:**
- Reflita sobre a eficácia da atribuição de papéis e a estratégia utilizada. *(entregar)*
- Avalie se a colaboração entre os papéis foi produtiva e se o escritor foi receptivo às sugestões. *(entregar)*
- Discuta a continuidade do uso dessa estratégia de atribuição de papéis em futuros projetos de grupo. *(entregar)*
- Analise como a estratégia afetou o engajamento e as interações durante a aula invertida. *(entregar)*

## Rubrica do Professor

| **Nível**  | **Critérios de Avaliação** |
|------------|---------------------------|
| **Nível 5** | ✅ Papéis excelentemente definidos e com alta eficácia na colaboração.<br>✅ Plano inicial e esboço exemplares, com contribuições significativas de todos os papéis.<br>✅ Alterações e *feedback* excepcionais que melhoram significativamente o programa.<br>✅ Reflexões detalhadas e perspicazes sobre a eficácia da estratégia, produtividade e engajamento. |
| **Nível 4** | ✅ Papéis bem definidos e eficazes na colaboração.<br>✅ Plano inicial e esboço bem desenvolvidos, com detalhamento eficaz.<br>✅ Alterações e *feedback* construtivos e bem integrados.<br>✅ Reflexões profundas sobre a produtividade e colaboração. |
| **Nível 3** | ⚠️ Papéis bem definidos e parcialmente eficazes na colaboração.<br>⚠️ Desenvolvimento inicial adequado com algumas áreas de melhoria.<br>⚠️ Alterações e *feedback* úteis, mas com espaço para melhorias.<br>⚠️ Reflexões adequadas, com algumas sugestões para melhorias futuras. |
| **Nível 2** | ❌ Papéis definidos, mas com cooperação e resultados ineficientes.<br>❌ Desenvolvimento inicial do plano ou esboço com falhas.<br>❌ Alterações e *feedback* superficiais pelo editor e revisor.<br>❌ Reflexões superficiais sobre a eficácia da estratégia. |
| **Nível 1** | ❌ Papéis não claramente definidos ou não assumidos adequadamente.<br>❌ Falha no desenvolvimento inicial do plano ou esboço do programa.<br>❌ Falta de colaboração efetiva entre os papéis.<br>❌ Reflexões pós-atividade ausentes ou inadequadas. |
...
A fase 4 dos resultados preliminares centra-se na avaliação reflexiva e nas reações dos estudantes às estratégias de aprendizagem autorregulada implementadas ao longo do curso de programação. Esta fase examina como os alunos avaliam sua própria progressão e os desafios enfrentados, além de refletir sobre o impacto dessas experiências em seu desenvolvimento pessoal e acadêmico. A análise destaca as percepções dos estudantes sobre a eficácia das rubricas educacionais e a integração das competências de autorregulação em seu repertório de habilidades de aprendizagem. Os resultados revelam o grau de internalização das estratégias de autorregulação pelos estudantes e fornecem \textit{insights} para futuras melhorias no projeto pedagógico e na estruturação curricular.
...
## Tarefa: aprendendo com os erros e acertos em programação.

## Importância da Tarefa
Muito pode ser ganho ao reservar um tempo para refletir e olhar para trás, para o que você fez, o que funcionou e o que não funcionou. Isso permitirá que você preveja qual estratégia usar para resolver problemas futuros. Um bom professor deve compreender e impressionar seus alunos com a visão de que nenhum problema se esgota por completo. Sempre resta algo para fazer; com estudo e penetração suficientes, podemos melhorar qualquer solução e, em qualquer caso, podemos sempre melhorar nosso entendimento da solução.
...
4. Reflita também sobre os diálogos ocorridos entre o professor e os outros estudantes (entregar).
5. Individualmente, reflita sobre:
   - O professor o ajudou a melhorar ainda mais seu código? (entregar).
   - O professor o ajudou a terminar seu código incompleto ou a consertá-lo? (entregar).
   - O professor o ajudou a superar limitações? (entregar).
   - O que aprendeu com seus erros? (entregar).
   - O que aprendeu com os erros alheios? (entregar).
   - O que aprendeu com seus acertos? (entregar).
   - O que aprendeu com os acertos alheios? (entregar).

## Rubrica do Professor

| **Nível**  | **Critérios de Avaliação** |
|------------|---------------------------|
| **Nível 5** | ✅ O aluno resolveu corretamente os problemas computacionais demandados pelo professor.<br>✅ O aluno reportou muito bem ao professor suas limitações, erros e acertos.<br>✅ O aluno dialogou muito bem com o professor e refletiu profundamente sobre as observações realizadas.<br>✅ O aluno refletiu muito bem sobre os diálogos ocorridos entre o professor e os outros estudantes.<br>✅ Respondeu as perguntas reflexivas de forma aprofundada. |
| **Nível 4** | ✅ O aluno resolveu corretamente os problemas computacionais demandados pelo professor.<br>✅ O aluno reportou razoavelmente bem ao professor suas limitações, erros e acertos.<br>✅ O aluno dialogou razoavelmente bem com o professor e refletiu sobre as observações realizadas.<br>✅ O aluno refletiu razoavelmente bem sobre os diálogos ocorridos entre o professor e os outros estudantes.<br>✅ Respondeu as perguntas reflexivas de forma satisfatória. |
| **Nível 3** | ⚠️ O aluno resolveu regularmente os problemas computacionais demandados pelo professor.<br>⚠️ O aluno reportou regularmente ao professor suas limitações, erros e acertos.<br>⚠️ O aluno dialogou regularmente com o professor e refletiu sobre as observações realizadas.<br>⚠️ O aluno refletiu regularmente sobre os diálogos ocorridos entre o professor e os outros estudantes.<br>⚠️ Respondeu as perguntas reflexivas de forma regular. |
| **Nível 2** | ❌ O aluno resolveu erroneamente os problemas computacionais demandados pelo professor.<br>❌ O aluno reportou de modo superficial ao professor suas limitações, erros e acertos.<br>❌ O aluno dialogou de modo superficial com o professor e refletiu superficialmente sobre as observações realizadas.<br>❌ O aluno refletiu de modo superficial sobre os diálogos ocorridos entre o professor e os outros estudantes.<br>❌ Respondeu as perguntas reflexivas de forma superficial. |
| **Nível 1** | ❌ O aluno não resolveu os problemas computacionais demandados pelo professor.<br>❌ O aluno não reportou ao professor suas limitações, erros e acertos.<br>❌ O aluno não dialogou com o professor nem refletiu sobre as observações realizadas pelo professor.<br>❌ O aluno não refletiu sobre os diálogos ocorridos entre o professor e os outros estudantes.<br>❌ Não entregou as respostas às perguntas reflexivas. |
...
3. **Individual:** Refletir sobre os seguintes questionamentos e entregar as respostas:
   - Avaliar conjuntamente diferentes soluções me ajudou a entender que pode haver mais de um programa para resolver o mesmo problema computacional?
   - O compartilhamento de diferentes pontos de vista me ajudou a aprender a programar?
   - Fiquei mais confiante para o acerto de minhas soluções após as discussões?
   - O compartilhamento de diferentes pontos de vista me ajudou a melhorar a qualidade do meu código?
   - Compartilhar conhecimento permitiu também compartilhar habilidades com meus parceiros?
   - As interações no grupo nos permitiram corrigir mais rapidamente os erros de lógica e sintaxe?
   - Senti-me mais responsável pela minha participação nos trabalhos?

## Rubrica do Professor

| **Nível**  | **Critérios de Avaliação** |
|------------|---------------------------|
| **Nível 5** | ✅ Código do programa completo e perfeitamente funcional.<br>✅ Resumo das discussões entregue com excelentes detalhes e profunda reflexão.<br>✅ Reconheceu plenamente os benefícios de múltiplas soluções.<br>✅ Percebeu excelentes benefícios no aprendizado de programação a partir de diferentes pontos de vista.<br>✅ Aumento excepcional de confiança nas suas soluções após discussões.<br>✅ Observou excelentes melhorias na qualidade do código através do compartilhamento.<br>✅ Percebeu um compartilhamento completo de habilidades entre parceiros.<br>✅ Viu excelentes melhorias na correção de erros de lógica e sintaxe com interações no grupo.<br>✅ Sentiu-se extremamente responsável pela sua participação nos trabalhos. |
| **Nível 4** | ✅ Código do programa completo e funcional, com pequenos erros de otimização.<br>✅ Resumo das discussões entregue com boa reflexão e detalhes.<br>✅ Reconheceu claramente os benefícios de múltiplas soluções.<br>✅ Percebeu claros benefícios no aprendizado de programação a partir de diferentes pontos de vista.<br>✅ Aumento significativo de confiança nas suas soluções após discussões.<br>✅ Observou claras melhorias na qualidade do código através do compartilhamento.<br>✅ Percebeu um compartilhamento eficaz de habilidades entre parceiros.<br>✅ Viu melhorias significativas na correção de erros de lógica e sintaxe com interações no grupo.<br>✅ Sentiu uma responsabilidade significativa pela sua participação nos trabalhos. |
| **Nível 3** | ⚠️ Código do programa completo, com alguns erros funcionais.<br>⚠️ Resumo das discussões entregue com reflexão adequada.<br>⚠️ Reconheceu de forma adequada os benefícios de múltiplas soluções.<br>⚠️ Percebeu benefícios moderados no aprendizado de programação a partir de diferentes pontos de vista.<br>⚠️ Aumento moderado de confiança nas suas soluções após discussões.<br>⚠️ Observou melhorias moderadas na qualidade do código através do compartilhamento.<br>⚠️ Percebeu um compartilhamento moderado de habilidades entre parceiros.<br>⚠️ Viu melhorias moderadas na correção de erros de lógica e sintaxe com interações no grupo.<br>⚠️ Sentiu uma responsabilidade moderada pela sua participação nos trabalhos. |
| **Nível 2** | ❌ Código do programa escrito mas incompleto ou não funcional.<br>❌ Entregou resumo das discussões, mas sem detalhes ou reflexão significativa.<br>❌ Reconheceu parcialmente os benefícios de múltiplas soluções.<br>❌ Percebeu levemente os benefícios no aprendizado de programação a partir de diferentes pontos de vista.<br>❌ Aumento leve de confiança nas suas soluções após discussões.<br>❌ Observou pequenas melhorias na qualidade do código através do compartilhamento.<br>❌ Percebeu um leve compartilhamento de habilidades entre parceiros.<br>❌ Viu alguma melhoria na correção de erros de lógica e sintaxe com interações no grupo.<br>❌ Sentiu um pouco mais de responsabilidade pela sua participação nos trabalhos. |
| **Nível 1** | ❌ O código do programa não foi escrito ou é completamente inoperante.<br>❌ Não entregou o resumo das discussões.<br>❌ Não reconheceu benefícios de múltiplas soluções.<br>❌ Não percebeu benefícios no aprendizado de programação.<br>❌ Não aumentou confiança.<br>❌ Não observou melhorias.<br>❌ Não percebeu compartilhamento de habilidades.<br>❌ Não viu melhorias na correção de erros.<br>❌ Não sentiu responsabilidade. |
...
- Individualmente, revise problemas e códigos anteriormente estudados que sejam relevantes para o problema atual. Pense em possíveis adaptações e soluções. (entregar)

### **Durante a sala de aula:**
- Apresente suas ideias de solução ao grupo. (entregar)
- Discutam conjuntamente as possíveis soluções, chegando a um consenso sobre a abordagem a seguir e desenvolvam o código juntos. (entregar)

### **Depois da sala de aula:**
- Reflita sobre a transferência de soluções de problemas anteriores para o problema atual. Explique por que essas soluções foram ou não eficazes. (entregar)
- Avalie se a experiência de codificação colaborativa foi positiva e por quê. (entregar)
- Discuta como a utilização desta estratégia impactou as interações e o engajamento durante e após a aula invertida. (entregar)

## Rubrica do Professor

| **Nível**  | **Critérios de Avaliação** |
|------------|---------------------------|
| **Nível 5** | ✅ Objetivos claros e bem articulados com total consenso do grupo.<br>✅ Aplicação exemplar de conhecimentos e experiências prévias, gerando soluções inovadoras.<br>✅ Apresentação de ideias de solução excepcionalmente persuasiva e completa.<br>✅ Código desenvolvido de maneira exemplar, com alta qualidade e reflexões profundas sobre o processo de aprendizado colaborativo.<br>✅ Reflexão excepcional sobre a transferência de soluções, demonstrando total compreensão das dinâmicas envolvidas.<br>✅ Avaliação excepcional da experiência colaborativa, destacando benefícios significativos e transformadores.<br>✅ Discussão profunda e influente sobre o impacto da estratégia, motivando mudanças e engajamento contínuo. |
| **Nível 4** | ✅ Excelente definição e consenso sobre os objetivos do projeto.<br>✅ Uso eficaz e inovador de conhecimentos e experiências prévias na solução de problemas.<br>✅ Apresentação de ideias de solução altamente convincente e bem estruturada.<br>✅ Código desenvolvido em alta colaboração, mostrando integração e funcionalidade.<br>✅ Reflexão profunda sobre a transferência de soluções com análises críticas e construtivas.<br>✅ Avaliação muito positiva da experiência colaborativa, com destaque para o aprendizado obtido.<br>✅ Discussão abrangente e impactante sobre o uso da estratégia e seus efeitos. |
| **Nível 3** | ⚠️ Objetivos bem definidos, com alguma colaboração efetiva na revisão de conhecimentos.<br>⚠️ Uso adequado de experiências prévias com algumas novas ideias bem integradas.<br>⚠️ Apresentação clara de ideias com algumas falhas na convicção ou detalhes.<br>⚠️ Código desenvolvido colaborativamente com resultados adequados.<br>⚠️ Reflexão adequada sobre a transferência de soluções com alguns insights valiosos.<br>⚠️ Avaliação positiva da experiência colaborativa com reconhecimento de áreas para melhoria.<br>⚠️ Discussão eficaz sobre o impacto da estratégia nas interações e engajamento. |
| **Nível 2** | ❌ Consenso sobre os objetivos alcançado, mas sem clareza.<br>❌ Revisão e aplicação limitada de conhecimentos prévios.<br>❌ Apresentou ideias de solução, mas sem convicção ou clareza.<br>❌ Discussão sobre soluções realizada, mas com pouca colaboração efetiva no código.<br>❌ Reflexão sobre a transferência de soluções limitada ou superficial.<br>❌ Avaliação da experiência colaborativa reconhece problemas sem propor soluções.<br>❌ Discussão sobre o impacto da estratégia mínima ou ineficaz. |
| **Nível 1** | ❌ Não conseguiu chegar a um consenso sobre os objetivos do projeto.<br>❌ Não revisou ou utilizou conhecimentos prévios na solução do problema.<br>❌ Não apresentou ideias de solução ao grupo.<br>❌ Não chegou a um consenso sobre a solução a ser adotada, e o código não foi desenvolvido colaborativamente.<br>❌ Não refletiu sobre a transferência de soluções de problemas anteriores.<br>❌ Não avaliou a experiência de codificação colaborativa.<br>❌ Não discutiu o impacto da estratégia nas interações e no engajamento. |
...
Esta tarefa simula um ambiente de trabalho realista onde os alunos aplicam técnicas de gerenciamento de projetos de software para planejar, executar e refletir sobre atividades de programação. O uso de ferramentas como Kanban e metodologias como SCRUM ensina os alunos a gerenciar suas tarefas de forma eficiente e eficaz, preparando-os para desafios profissionais futuros.

## Área: Desenvolvimento de Software e Gerenciamento de Projetos

## Autorregulação

| **Passo** | **Atividade** |
|-----------|--------------|
| **Antes da sala de aula** | ✅ Refletir individualmente sobre as demandas das tarefas e planejar conforme diretrizes do professor (entregar).<br>✅ Agendar encontros com o professor para discussão e *feedback*.<br>✅ Estabelecer estratégias de realização e monitoramento de tarefas usando ferramentas como Kanban (entregar).<br>✅ Organizar um plano de ação que defina tecnologias a serem usadas, como GitHub, e papéis no grupo, utilizando SCRUM (entregar). |
| **Durante a sala de aula** | ✅ Fazer anotações sobre o desempenho do grupo e a comunicação interna (entregar).<br>✅ Monitorar o cumprimento das regras e a participação nas atividades (entregar).<br>✅ Gerenciar o tempo e assegurar o cumprimento dos prazos (entregar).<br>✅ Acatar *feedback* do professor e ajustar estratégias conforme necessário. |
| **Depois da sala de aula** | ✅ Propor mudanças com base na performance do grupo e *feedback* recebido (entregar).<br>✅ Refletir sobre a eficácia do gerenciamento do projeto e como isso impactou a aprendizagem e a interação do grupo (entregar).<br>✅ Avaliar a utilidade da estratégia de planejamento na aprendizagem e se pretende utilizá-la futuramente (entregar). |

## Rubrica do Professor

| **Nível**  | **Critérios de Avaliação** |
|------------|---------------------------|
| **Nível 5** | ✅ Planejamento inicial exemplar, com perfeita atenção a todos os detalhes e requisitos.<br>✅ Estratégias de monitoramento implementadas de forma exemplar, sem falhas.<br>✅ Plano de ação extremamente detalhado, com clareza perfeita em tecnologias e definição de papéis.<br>✅ Anotações sobre o desempenho do grupo excepcionalmente detalhadas e completamente informativas.<br>✅ Monitoramento de regras e participação realizado de forma impecável, sem falhas.<br>✅ Gerenciamento de tempo perfeito, sem qualquer desvio dos prazos estabelecidos.<br>✅ Propostas de mudanças excepcionais, mostrando inovação e uma compreensão profunda das necessidades do projeto.<br>✅ Reflexão excepcional sobre o gerenciamento do projeto, com insights profundos e transformadores.<br>✅ Avaliação minuciosa e excepcional da utilidade do planejamento, destacando todos os benefícios e influências positivas. |
| **Nível 4** | ✅ Planejamento inicial muito bem realizado, com detalhamento e consideração de quase todos os aspectos necessários.<br>✅ Estratégias de monitoramento muito eficazes, com apenas detalhes menores a melhorar.<br>✅ Plano de ação detalhado e bem organizado, quase exemplar na definição de tecnologias e papéis.<br>✅ Anotações sobre o desempenho do grupo muito detalhadas e informativas.<br>✅ Monitoramento de regras e participação bem feito, com muito poucos erros.<br>✅ Gerenciamento de tempo muito eficiente, com raras exceções ao cumprimento de prazos.<br>✅ Propostas de mudanças inteligentes e bem planejadas, mostrando uma clara compreensão das necessidades do projeto.<br>✅ Reflexão profunda e crítica sobre o gerenciamento do projeto, oferecendo insights valiosos.<br>✅ Avaliação completa da utilidade do planejamento, mostrando uma análise profunda dos impactos. |
| **Nível 3** | ⚠️ Planejamento inicial feito de maneira adequada, atendendo à maioria das exigências.<br>⚠️ Estratégias de monitoramento bem implementadas, mas com espaço para melhorias.<br>⚠️ Plano de ação claro e com detalhamento adequado, mas pode ser mais completo.<br>⚠️ Anotações sobre o desempenho do grupo completas e bastante informativas.<br>⚠️ Bom monitoramento de regras e participação, com pequenos lapsos.<br>⚠️ Gerenciamento de tempo eficiente, mantendo o projeto no prazo com pequenas exceções.<br>⚠️ Propostas de mudanças bem fundamentadas, mas que podem ser mais inovadoras.<br>⚠️ Reflexão consciente sobre o gerenciamento do projeto, com algumas boas percepções.<br>⚠️ Avaliação bem-feita da utilidade do planejamento, reconhecendo a maioria dos benefícios e desvantagens. |
| **Nível 2** | ❌ Planejamento inicial feito de maneira rudimentar e pouco eficaz.<br>❌ Estratégias de monitoramento implementadas parcialmente, com eficácia limitada.<br>❌ Plano de ação superficial, com poucos detalhes e fraca definição de papéis.<br>❌ Anotações sobre o desempenho do grupo incompletas e pouco informativas.<br>❌ Monitoramento de regras e participação feito de forma inconsistente.<br>❌ Gerenciamento de tempo básico, apenas seguindo o mínimo necessário.<br>❌ Propostas de mudanças genéricas e pouco fundamentadas.<br>❌ Reflexão superficial sobre o gerenciamento do projeto, com pouca crítica construtiva.<br>❌ Avaliação básica da utilidade do planejamento, sem profundidade. |
| **Nível 1** | ❌ Planejamento inicial não realizado ou feito sem considerar requisitos básicos.<br>❌ Estratégias de monitoramento completamente ausentes ou ineficazes.<br>❌ Plano de ação não criado ou sem clareza e detalhamento.<br>❌ Anotações sobre o desempenho do grupo totalmente ausentes.<br>❌ Falha em monitorar regras e participação, resultando em desordem.<br>❌ Gerenciamento de tempo inexistente, causando atrasos graves.<br>❌ Ausência de propostas de mudanças após análise da performance.<br>❌ Nenhuma reflexão sobre o gerenciamento do projeto, sem aprendizado identificado.<br>❌ Falta de avaliação sobre a utilidade do planejamento. |


## Corregulação e Regulação Compartilhada

### **Tarefa:** analisando prós e contras em programação

### **Importância da Tarefa**
A controvérsia acadêmica é uma técnica de aprendizagem colaborativa que permite aos alunos examinar e refutar diferentes pontos de vista sobre um tópico, estimulando o pensamento crítico e a tolerância à ambiguidade. Este método é aplicado aqui para discutir a utilização de estruturas de controle em programação, especificamente comparando as estruturas de seleção IF e SWITCH CASE.

### **Definição do Problema**
Decidir qual estrutura de seleção, IF ou SWITCH CASE, é mais apropriada para um problema especificado pelo professor, considerando os aspectos teóricos e práticos de cada uma.
...
4. **Implementação prática:** implementar pelo menos duas versões dos algoritmos, uma para cada estrutura de controle, e discutir suas vantagens e desvantagens em termos práticos (entregar os códigos e discussões).

## Rubrica do Professor

| **Nível**  | **Critérios de Avaliação** |
|------------|---------------------------|
| **Nível 5** | ✅ Reflexão profunda e insight sobre a técnica.<br>✅ Argumentos excelentes e bem fundamentados.<br>✅ Discussão excelente, alcançando consenso ou relatório bem elaborado.<br>✅ Implementação perfeita e análise detalhada dos algoritmos. |
| **Nível 4** | ✅ Reflexão detalhada e crítica sobre a técnica.<br>✅ Argumentos bem preparados.<br>✅ Participação ativa e construtiva na discussão.<br>✅ Implementação correta de ambos os algoritmos. |
| **Nível 3** | ⚠️ Reflexão adequada.<br>⚠️ Argumentos razoavelmente preparados.<br>⚠️ Boa participação na discussão.<br>⚠️ Implementação adequada, mas com falhas nos algoritmos. |
| **Nível 2** | ❌ Reflexão superficial sobre a técnica.<br>❌ Argumentos mal preparados.<br>❌ Participação mínima na discussão.<br>❌ Implementação inadequada dos algoritmos. |
| **Nível 1** | ❌ Não refletiu sobre a técnica.<br>❌ Não preparou argumentos.<br>❌ Não participou da discussão em grupo.<br>❌ Não implementou os algoritmos. |
